              ...
              <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left pp-5">
                    <div class="brand-logo">
                        <h1 style="text-align: center; color:#000000;">Remedi</h1>
                      </div>
                  <h3 style="text-align: center; color:#a83dff;">Login</h3>
                  {{-- <h6 class="font-weight-light" style="text-align: center;">Sign in to continue.</h6> --}}
                  <div class="form-group">
                    <input type="text" name="user_id" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="User Id">
                  </div>
                  <div class="form-group">
